...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© حقوق الطبع والنشر 2023 - :current_year، سكاي كير. جميع الحقوق محفوظة.',
        ...
        'account' => [
            ...
            'addresses' => [
                ...
                'state'            => 'المحافظة',
                'block-address'   => 'القطعة',
                'street-address'   => 'الشارع',
                'floor-address'   => 'الدور',
                'flat-address'   => 'الشقة',
                'avenue-address'   => 'الجادة',
                'note-address'     => 'ملاحظة',
                'house-address'   => 'رقم المنزل',
                'title'            => 'العنوان',
                'vat-id'           => 'معرف VAT',
            ],
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'mini-cart' => [
                ...
                'offer-on-orders'      => 'قم بإنشاء حساب واحصل على خصم يصل إلى 15٪ على طلبك الأول',
                'remove'               => 'إزالة',
                'see-details'          => 'رؤية التفاصيل',
    ...
    'emails' => [
        ...
        'orders' => [
            ...
            'abandoned' => [
                'greeting' => 'لاحظنا أنك قد أضفت بعض المنتجات إلى سلة التسوق الخاصة بك ولكن لم تكمل عملية الشراء.',
                'greeting2' => 'لا داعي للقلق، المنتجات التي اخترتها لا تزال في سلة التسوق الخاصة بك. إذا كنت بحاجة إلى مساعدة في إكمال الطلب أو لديك أي أسئلة، نحن هنا للمساعدة!',
                'subject'  => 'تذكير بوجود منتجات في سلة التسوق الخاصة بك',
                'summary'  => 'ملخص الطلب',
                'title'    => 'تذكير بوجود طلب غير مكتمل!',
                'footer1'  => 'يمكنك إكمال الطلب بسهولة بالنقر على الرابط التالي:',
                'url'      => 'إكمال الطلب',
                'footer2'  => 'شكراً لتسوقك معنا!',
            ],
