                ...
                <x-shop::form v-slot="{ meta, errors, values, handleSubmit }" as="div"
                    ...
                    <form @submit="handleSubmit($event, storeCustomerShippingAddressToCart)">
                        ...
                        <div class="flex justify-end mt-4"
                            v-if="customershippingAddresses.length && customerShippingAddresses.length">
                    ...
                    <form @submit="handleSubmit($event, updateOrCreateCustomerAddress)">
                        ...
                        <div class="grid grid-cols-2 gap-x-5" v-if="values.shipping?.country == 'KW'">
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="shipping.address1[3]"
                                    ::value="customer.updateOrCreateShippingAddress.params.address1 && customer
                                        .updateOrCreateShippingAddress.params.address1.length > 3 ? customer
                                        .updateOrCreateShippingAddress.params.address1[3] : ''" rules="address" :label="trans('shop::app.checkout.onepage.addresses.shipping.floor-address')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.floor-address')" />
                        ...
                        <div class="grid grid-cols-2 gap-x-5" v-if="values.shipping?.country == 'KW'">
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="shipping.address1[4]"
                                    ::value="customer.updateOrCreateShippingAddress.params.address1 && customer
                                        .updateOrCreateShippingAddress.params.address1.length > 4 ? customer
                                        .updateOrCreateShippingAddress.params.address1[4] : ''" rules="address" :label="trans('shop::app.checkout.onepage.addresses.shipping.flat-address')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.flat-address')" />
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control type="text" name="shipping.address1[5]"
                                    ::value="customer.updateOrCreateShippingAddress.params.address1 && customer
                                        .updateOrCreateShippingAddress.params.address1.length > 5 ? customer
                                        .updateOrCreateShippingAddress.params.address1[5] : ''" rules="address" :label="trans('shop::app.checkout.onepage.addresses.shipping.avenue-address')" :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.avenue-address')" />
                        ...
                        <x-shop::form.control-group v-if="values.shipping?.country != 'KW'">
                            ...
                            @if (core()->getConfigData('customer.address.information.street_lines') > 1)
                                @for ($i = 1; $i < core()->getConfigData('customer.address.information.street_lines'); $i++)
                                    <x-shop::form.control-group.control type="text"
                                        name="shipping.address1[{{ $i }}]" :label="trans('shop::app.checkout.onepage.addresses.shipping.street-address')"
                                        :placeholder="trans('shop::app.checkout.onepage.addresses.shipping.street-address')" />
                                @endfor
                            @endif
                        </x-shop::form.control-group>
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" ::value="customer.updateOrCreateShippingAddress.params.note" name="shipping.note"
