...
@pushOnce('scripts')
    <script
        ...
        id="v-dashboard-total-sales-month-template"
    >
        <!-- Shimmer -->
    ...
    <script type="module">
        app.component('v-dashboard-total-sales-month', {
            template: '#v-dashboard-total-sales-month-template',
            ...
            methods: {
                getStats(filtets) {
                    ...
                    filtets.type = 'total-sales-month';
