...
<v-wholesale-dashboard-todays-details>
    <!-- Shimmer -->
...
@pushOnce('scripts')
    <script
        ...
        id="v-wholesale-dashboard-todays-details-template"
    >
        <!-- Shimmer -->
                ...
                <div class="flex gap-4 flex-wrap p-4 bg-white dark:bg-gray-900 border-b dark:border-gray-800">
                    ...
                    <div class="flex gap-2.5 flex-1">
                        <img
                            ...
                            title="@lang('admin::app.dashboard.index.today-wholesale-sales')"
                        >
    ...
    <script type="module">
        app.component('v-wholesale-dashboard-todays-details', {
            template: '#v-wholesale-dashboard-todays-details-template',
