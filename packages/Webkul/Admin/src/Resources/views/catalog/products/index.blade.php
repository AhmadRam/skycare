    ...
    <x-admin::datagrid src="{{ route('admin.catalog.products.index') }}" :isMultiRow="true">
        ...
        <template #header="{ columns, records, sortPage, selectAllRecords, applied, isLoading}">
            <template v-if="! isLoading">
                <div
                    class="row grid grid-cols-[2fr_1fr_1fr] grid-rows-1 items-center px-4 py-2.5 border-b dark:border-gray-800">
                    <div class="flex gap-2.5 items-center select-none"
                        ...
                        @if ($hasPermission)
                            <label class="flex gap-1 items-center w-max cursor-pointer select-none"
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            ...
                            <i class="ltr:ml-1.5 rtl:mr-1.5 text-base text-gray-800 dark:text-white align-text-bottom"
        ...
        <template #body="{ columns, records, setCurrentSelectionMode, applied, isLoading }">
            <template v-if="! isLoading">
                <div class="row grid grid-cols-[2fr_1fr_1fr] grid-rows-1 px-4 py-2.5 border-b dark:border-gray-800   transition-all hover:bg-gray-50 dark:hover:bg-gray-950"
                    ...
                    <div class="flex gap-2.5">
                        ...
                        <div class="flex flex-col gap-1.5">
                            <p class="text-base text-gray-800 dark:text-white font-semibold" v-text="record.name">
                            </p>
                    ...
                    <div class="flex gap-1.5">
                        <div class="relative">
                            <template v-if="record.base_image">
                                <img class="min-h-[65px] min-w-[65px] max-h-[65px] max-w-[65px] rounded"
                            ...
                            <template v-else>
                                <div
                                    class="w-full h-[60px] max-w-[60px] max-h-[60px] relative border border-dashed border-gray-300 dark:border-gray-800 rounded dark:invert dark:mix-blend-exclusion">
                                    <img src="{{ bagisto_asset('images/product-placeholders/front.svg') }}">

                                    <p
                                        class="w-full absolute bottom-1.5 text-[6px] text-gray-400 text-center font-semibold">
                    ...
                    <div class="flex gap-x-4 justify-between items-center">
                        <div class="flex flex-col gap-1.5">
                            ...
                            <p class="text-gray-600 dark:text-gray-300" v-text="record.category_name ?? 'N/A'">
                            </p>

                            <p class="text-gray-600 dark:text-gray-300" v-text="record.type">
                            </p>
                        </div>
                        ...
                        <div class="flex gap-1.5 items-center">
                            <a :href=`{{ route('admin.catalog.products.copy', '') }}/${record.product_id}`>
                                <span
                                    class="icon-copy text-2xl ltr:ml-1 rtl:mr-1 p-1.5 rounded-md cursor-pointer transition-all hover:bg-gray-200 dark:hover:bg-gray-800"></span>
                            </a>

                            <a :href=`{{ route('admin.catalog.products.edit', '') }}/${record.product_id}`>
                                <span
                                    class="icon-sort-right text-2xl ltr:ml-1 rtl:mr-1 p-1.5 rounded-md cursor-pointer transition-all hover:bg-gray-200 dark:hover:bg-gray-800"></span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <script>
            function submitImportForm() {
                ...
                if (confirmation) {
                    ...
                    fetch("{{ route('admin.catalog.products.import') }}", {
                            method: "POST",
                            body: formData,
                            headers: {
