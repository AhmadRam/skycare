        ...
        >
            ...
            >
                <div class="flex justify-between items-center">
                    ...
                    <input type="file" class="control" name="attributes" id="fileInput" style="display: none"
                        onchange="submitImportForm()">
                        <input type="text" id="attribute_name" name="attribute_name" value="{{ $attribute->code }}" hidden>
                    <div>
                        <div>
                            <p class="text-gray-600 dark:text-gray-300 font-semibold leading-[24px]" onclick="openFileInput()"> Import
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            function submitImportForm() {
                ...
                if (confirmation) {
                    ...
                    formData.append('attributes', fileInput.files[0]);
                    formData.append('attribute_name', attribute_name.value);

                    fetch("{{ route('admin.catalog.attributes.import') }}", {
                            method: "POST",
                            body: formData,
                            headers: {
