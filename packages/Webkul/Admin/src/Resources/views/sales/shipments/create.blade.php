                                            ...
                                            <div class="flex gap-2.5">
                                                ...
                                                <div class="grid gap-1.5 place-content-start">
                                                    ...
                                                    <div class="flex flex-col gap-1.5 place-items-start">
                                                        ...
                                                        <!--Item Status -->
                                                        <p class="text-gray-600 dark:text-gray-300">
                                                            {{ $item->qty_ordered ? trans('admin::app.sales.shipments.create.item-ordered', ['qty_ordered' => $item->qty_ordered + ($item->additional['extra_qty'] ?? 0)]) : '' }}

                                                            {{ $item->qty_invoiced ? trans('admin::app.sales.shipments.create.item-invoice', ['qty_invoiced' => $item->qty_invoiced + ($item->additional['extra_qty'] ?? 0)]) : '' }}

                                                            {{ $item->qty_shipped ? trans('admin::app.sales.shipments.create.item-shipped', ['qty_shipped' => $item->qty_shipped + ($item->additional['extra_qty'] ?? 0)]) : '' }}

                                                            {{ $item->qty_refunded ? trans('admin::app.sales.shipments.create.item-refunded', ['qty_refunded' => $item->qty_refunded + ($item->additional['extra_qty'] ?? 0)]) : '' }}

                                                            {{ $item->qty_canceled ? trans('admin::app.sales.shipments.create.item-canceled', ['qty_canceled' => $item->qty_canceled + ($item->additional['extra_qty'] ?? 0)]) : '' }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="flex gap-2.5 items-center">
                                                    ...
                                                    <x-admin::form.control-group class="!mb-0">
                                                        <x-admin::form.control-group.control
                                                            ...
                                                            :id="$inputName"
                                                            :name="$inputName"
                                                            :rules="'required|numeric|min_value:0|max_value:' . ($item->qty_ordered + ($item->additional['extra_qty'] ?? 0))"
                                                            :value="$item->qty_to_ship + ($item->additional['extra_qty'] ?? 0)"
