...
<v-reporting-wholesale-customers-with-most-sales>
    <!-- Shimmer -->
...
@pushOnce('scripts')
    <script
        ...
        id="v-reporting-wholesale-customers-with-most-sales-template"
    >
        <!-- Shimmer -->
            ...
            <div class="flex-1 relative p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                ...
                <div class="flex items-center justify-between mb-4">
                    <p class="text-base text-gray-600 dark:text-white font-semibold">
                        @lang('admin::app.reporting.customers.index.customers-with-most-sales') (wholesale)
                    </p>

                    <a
                        href="{{ route('admin.reporting.customers.view', ['type' => 'wholesale-customers-with-most-sales']) }}"
    ...
    <script type="module">
        app.component('v-reporting-wholesale-customers-with-most-sales', {
            template: '#v-reporting-wholesale-customers-with-most-sales-template',
            ...
            methods: {
                getStats(filtets) {
                    ...
                    filtets.type = 'wholesale-customers-with-most-sales';
