...
return [
    ...
    [
        'key'        => 'sales.abandoned-orders',
        'name'       => 'admin::app.components.layouts.sidebar.abandoned-orders',
        'route'      => 'admin.sales.abandoned-orders.index',
        'sort'       => 2,
        'icon'       => '',
    ],
    [
    ...
    [
        'key'        => 'reporting.product_sales_report',
        'name'       => 'admin::app.reporting.products.sales.title',
        'route'      => 'admin.reporting.product_sales_report.index',
        'sort'       => 4,
        'icon'       => '',
    ],
    [
