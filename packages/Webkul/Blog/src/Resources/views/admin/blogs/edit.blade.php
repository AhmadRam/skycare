            ...
            <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field type="text" name="name" value="{{ old('name') ?? $blog->name }}"
                            label="{{ trans('blog::app.blog.name') }}" rules="required" v-slot="{ field }">
                            <input type="text" name="name" id="name" v-bind="field"
                                :class="[errors['{{ 'name' }}'] ? 'border border-red-600 hover:border-red-600' : '']"
                                class="flex w-full min-h-[39px] py-2 px-3 border rounded-md text-sm text-gray-600 dark:text-gray-300 transition-all hover:border-gray-400 dark:hover:border-gray-400 focus:border-gray-400 dark:focus:border-gray-400 dark:bg-gray-900 dark:border-gray-800"
                                placeholder="{{ trans('blog::app.blog.name') }}" v-slugify-target:slug="setValues">
                        </v-field>
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field type="text" name="slug" value="{{ old('slug') ?? $blog->slug }}"
                            label="{{ trans('admin::app.catalog.categories.create.slug') }}" rules="required"
                            v-slot="{ field }">
                            <input type="text" name="slug" id="slug" v-bind="field"
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <x-admin::form.control-group.control type="textarea" name="short_description"
                            id="short_description" rules="required" :value="old('short_description') ?? $blog->short_description" :label="trans('blog::app.blog.short_description')"
                            :placeholder="trans('blog::app.blog.short_description')">
                        </x-admin::form.control-group.control>

                        <x-admin::form.control-group.error
                            control-name="short_description"></x-admin::form.control-group.error>
                    ...
                    <v-description>
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="textarea" name="description" id="description"
                                class="description" rules="required" :value="old('description') ?? $blog->description" :label="trans('blog::app.blog.description')"
                    ...
                    <div class="flex gap-12">
                        ...
                        <div class="flex flex-col gap-2 w-2/5 mt-5">
                            <p class="text-gray-800 dark:text-white font-medium">
                                @lang('blog::app.blog.cover')
                            </p>

                            <x-admin::media.images name="cover" :uploaded-images="$blog->cover ? [['id' => 'cover', 'url' => $blog->cover_url]] : []">
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <div class="mt-8">
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="text" name="meta_title" id="meta_title"
                                {{-- rules="required" --}} :value="old('meta_title') ?? $blog->meta_title" :label="trans('blog::app.blog.meta_title')" :placeholder="trans('blog::app.blog.meta_title')">
                            </x-admin::form.control-group.control>

                            <x-admin::form.control-group.error
                                control-name="meta_title"></x-admin::form.control-group.error>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="text" name="meta_keywords"
                                {{-- rules="required" --}} :value="old('meta_keywords') ?? $blog->meta_keywords" :label="trans('blog::app.blog.meta_keywords')" :placeholder="trans('blog::app.blog.meta_keywords')">
                            </x-admin::form.control-group.control>

                            <x-admin::form.control-group.error
                                control-name="meta_keywords"></x-admin::form.control-group.error>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="textarea" name="meta_description"
                                id="meta_description" {{-- rules="required" --}} :value="old('meta_description') ?? $blog->meta_description" :label="trans('blog::app.blog.meta_description')"
                                :placeholder="trans('blog::app.blog.meta_description')">
                            </x-admin::form.control-group.control>

                            <x-admin::form.control-group.error
                                control-name="meta_description"></x-admin::form.control-group.error>
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group class="w-full mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="date" name="published_at" id="published_at"
                                rules="required" :value="old('published_at') ??
                                    date_format(date_create($blog->published_at), 'Y-m-d')" :label="trans('blog::app.blog.published_at')" :placeholder="trans('blog::app.blog.published_at')">
                            </x-admin::form.control-group.control>
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="switch" name="status_switch"
                                id="status_switch" class="cursor-pointer" value="1" :label="trans('blog::app.blog.status')"
                                :checked="(bool) $selectedValue_status">
                            </x-admin::form.control-group.control>
                        </x-admin::form.control-group>

                        <!-- Allow Comments -->
                        <input type="hidden" name="allow_comments" id="allow_comments"
                            value="@php echo $blog->allow_comments @endphp">
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label class="text-gray-800 dark:text-white font-medium">
                            ...
                            <x-admin::form.control-group.control type="switch" name="allow_comments_switch"
                                class="cursor-pointer" value="1" :label="trans('blog::app.blog.allow_comments')" :checked="(bool) $selectedValue_allow_comments">
                            </x-admin::form.control-group.control>
                        </x-admin::form.control-group>
                        ...
                        @php
                            ...
                            $role = array_key_exists('role', $loggedIn_user)
                                ? (array_key_exists('name', $loggedIn_user['role'])
                                    ? $loggedIn_user['role']['name']
                                    : 'Administrator')
                                : 'Administrator';
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            @if ($role != 'Administrator')
                                ...
                                <x-admin::form.control-group.control type="text" name="author" rules="required"
                                    disabled="disabled" :value="$user_name" :label="trans('blog::app.blog.author')" :placeholder="trans('blog::app.blog.author')">
                                </x-admin::form.control-group.control>
                            @else
                                <x-admin::form.control-group.control type="select" name="author_id" id="author_id"
                                    {{-- class="cursor-pointer" --}} rules="required" :value="old('author_id') ?? $blog->author_id" :label="trans('blog::app.blog.author')"
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="select" name="default_category"
                                id="default_category" {{-- class="cursor-pointer" --}} {{-- rules="required" --}} :value="old('default_category') ?? $blog->default_category"
                                :label="trans('blog::app.blog.default_category')">
                                <!-- Options -->
                                <option value="">Select an category</option>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" data-slug="{{ $category->slug }}"
                                        id="{{ 'default_category' . $category->id }}"
                                        {{ $blog->default_category == $category->id ? 'selected' : '' }}>
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <div class="flex flex-col gap-[12px]">
                            <x-admin::tree.view input-type="checkbox" name-field="categorys" id-field="id"
                                value-field="id" :items="json_encode($additional_categories)" :value="json_encode(explode(',', $blog->categorys))" behavior="no"
                    ...
                    <x-slot:content>
                        @foreach ($tags as $tag)
                            <x-admin::form.control-group class="flex gap-2.5 !mb-0 p-1.5">
                                <x-admin::form.control-group.control type="checkbox" name="tags[]" :id="$tag->name"
                                    :value="$tag->id" rules="required" :for="$tag->name" :label="trans('blog::app.blog.tags')"
                                    :checked="in_array($tag->id, explode(',', $blog->tags))">
                                </x-admin::form.control-group.control>

                                <x-admin::form.control-group.label :for="$tag->name"
        ...
        <script type="module">
            app.component('v-seo-helper-custom', {
                ...
                mounted() {
                    ...
                    self.metaSlugCategory = (d_cat_slug != '' && d_cat_slug != null && d_cat_slug != undefined) ?
                        d_cat_slug : '';
                    ...
                    document.getElementById('default_category').addEventListener('change', function(e) {
                        var cat_slug = document.getElementById('default_category' + e.target.value)
                            .getAttribute("data-slug");
                        self.metaSlugCategory = (cat_slug != '' && cat_slug != null && cat_slug != undefined) ?
                            cat_slug : '';
                    });

                    document.getElementById('status_switch').addEventListener('change', function(e) {
                        document.getElementById('status').value = (e.target.checked == true || e.target
                            .checked == 'true') ? 1 : 0;
                    });

                    document.getElementById('allow_comments_switch').addEventListener('change', function(e) {
                        document.getElementById('allow_comments').value = (e.target.checked == true || e.target
                            .checked == 'true') ? 1 : 0;
                    });
