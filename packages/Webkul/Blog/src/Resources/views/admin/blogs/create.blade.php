            ...
            <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field type="text" name="name" value="{{ old('name') }}"
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <v-field type="text" name="slug" value="{{ old('slug') }}"
                ...
                <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                    ...
                    <x-admin::form.control-group class="mb-2.5">
                        ...
                        <x-admin::form.control-group.control type="textarea" name="short_description"
                            id="short_description" rules="required" :value="old('short_description')" :label="trans('blog::app.blog.short_description')"
                    ...
                    <v-description>
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="textarea" name="description" id="description"
                                class="description" rules="required" :value="old('description')" :label="trans('blog::app.blog.description')"
                    ...
                    <div class="flex gap-12">
                        ...
                        <div class="flex flex-col gap-2 w-2/5 mt-5">
                            ...
                            <x-admin::media.images name="cover"></x-admin::media.images>

                            <x-admin::form.control-group.error control-name="cover"></x-admin::form.control-group.error>
                    ...
                    <div class="mt-8">
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="text" name="meta_title" id="meta_title"
                                {{-- rules="required" --}} :value="old('meta_title')" :label="trans('blog::app.blog.meta_title')" :placeholder="trans('blog::app.blog.meta_title')">
                            </x-admin::form.control-group.control>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="text" name="meta_keywords"
                                {{-- rules="required" --}} :value="old('meta_keywords')" :label="trans('blog::app.blog.meta_keywords')" :placeholder="trans('blog::app.blog.meta_keywords')">
                            </x-admin::form.control-group.control>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="textarea" name="meta_description"
                                id="meta_description" {{-- rules="required" --}} :value="old('meta_description')" :label="trans('blog::app.blog.meta_description')"
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group class="w-full mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="date" name="published_at" id="published_at"
                                rules="required" :value="old('published_at') ?? date('Y-m-d')" :label="trans('blog::app.blog.published_at')" :placeholder="trans('blog::app.blog.published_at')">
                            </x-admin::form.control-group.control>
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="switch" name="status" class="cursor-pointer"
                                value="1" :label="trans('blog::app.blog.status')">
                            </x-admin::form.control-group.control>
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="switch" name="allow_comments"
                                class="cursor-pointer" value="1" :label="trans('blog::app.blog.allow_comments')">
                            </x-admin::form.control-group.control>
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            @else
                                <x-admin::form.control-group.control type="select" name="author_id" id="author_id"
                                    {{-- class="cursor-pointer" --}} rules="required" :value="old('author_id') ?? $user_id" :label="trans('blog::app.blog.author')"
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group class="mb-2.5">
                            ...
                            <x-admin::form.control-group.control type="select" name="default_category"
                                id="default_category" {{-- class="cursor-pointer" --}} {{-- rules="required" --}} :value="old('default_category')"
                                :label="trans('blog::app.blog.default_category')">
                                <!-- Options -->
                                <option value="">Select an category</option>
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" data-slug="{{ $category->slug }}"
                                        id="{{ 'default_category' . $category->id }}">{{ $category->name }}</option>
                                @endforeach
                            </x-admin::form.control-group.control>
                    ...
                    <x-slot:content>
                        ...
                        <div class="flex flex-col gap-[12px]">
                            <x-admin::tree.view input-type="checkbox" name-field="categorys" id-field="id"
                                value-field="id" :items="json_encode($additional_categories)" behavior="no" :fallback-locale="config('app.fallback_locale')">
                            </x-admin::tree.view>
                        </div>
